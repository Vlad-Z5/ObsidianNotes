...
- **Compute Optimised:** `c6g` / `c6i` / `c7i`
- **Memory Optimised:** `r6i` / `r6a` / `r7i`, `x2idn` / `x2iedn` (High Memory)
- **Storage Optimised:** `i4i` / `i3` (High IOPS), `d3` / `d3en` (Dense HDD)
- **GPU Optimised:** `g4dn` / `g5` (General Purpose), `p3` / `p4` (ML Training)
- **Machine Learning Inference Optimised:** `inf1`
- **High Performance Computing Optimised:** `hpc6id` / `hpc6a`
